...
public class SPUM_SpriteList : MonoBehaviour
{
    ...
    {
        List<List<SpriteRenderer>> allLists = new List<List<SpriteRenderer>>
        {
            _itemList, _eyeList, _hairList, _bodyList, _clothList, 
            _armorList, _pantList, _weaponList, _backList 
        };
